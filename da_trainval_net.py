...
def parse_args():
  ...
  parser.add_argument('--save_dir', dest='save_dir',
                      help='directory to save models', default="./data/Experiment/da_model",
                      type=str)
...
if __name__ == '__main__':
  ...
  args.cfg_file = "cfgs/{}_ls.yml".format(args.net) if args.large_scale else "cfgs/{}.yml".format(args.net)#cfgs/vgg16.yml
  ...
  if args.resume:
    load_name = os.path.join(output_dir,
      'train_{}_{}.pth'.format( args.checkepoch, args.checkpoint))
  ...
  for epoch in range(args.start_epoch, args.max_epochs + 1):
    ...
    for step in range(1, iters_per_epoch + 1):
      ...
      if 4 < epoch < 16 and step % 2000 == 0 and step != 10000:
          save_name = os.path.join(output_dir, 'train_%d_%d_%d.pth' % (args.session, epoch, step))
          save_checkpoint({
