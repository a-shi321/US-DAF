...
def combined_roidb(imdb_names, training=True):   #dataset name
  ...
  def get_roidb(imdb_name):
    print("进入factory之前看看输入的是个啥", imdb_name)
    imdb = get_imdb(imdb_name)     #从这开始读检索一下输入的书记名字四否存在 return a pascal_voc dataset object     get_imdb is from factory which contain all legal dataset object
    print("从factory输出后看看输出的是个啥", imdb)
